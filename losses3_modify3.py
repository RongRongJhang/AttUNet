...
class CombinedLoss(nn.Module):
    def __init__(self, device):
        ...
        # 調整後的權重參數
        self.alpha1 = 1.00  # Smooth L1 (保持不變)
        self.alpha2 = 0.15  # 感知損失 (略微降低，因為新增了色彩損失)
        self.alpha3 = 0.05  # 直方圖損失 (保持不變)
        self.alpha4 = 0.80  # MS-SSIM (保持不變)
        self.alpha5 = 0.005 # PSNR (保持不變)
        self.alpha6 = 0.10  # 新增的色彩/亮度損失
