...
class MSEFBlock(nn.Module):
    def __init__(self, filters):
        ...
        self.attn = ShuffleAttention(filters)
        self._init_weights()
...
class CBAdjustment(nn.Module):
    def __init__(self, channels):
        super(CBAdjustment, self).__init__()
...
class LaaFNet(nn.Module):
    def __init__(self, filters=48):
        ...
        self.cb_adjust = CBAdjustment(filters)
    ...
    def forward(self, inputs):      
        ...
        color_weights, brightness_map = self.cb_adjust(enhanced)
